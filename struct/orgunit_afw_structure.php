...
class HrmOrgunitAfwStructure
{
	...
	public static $DB_STRUCTURE = array(
		...
		'subOrgList' => array(
			...
			'SHOW' => true,
			'FORMAT' => 'retrieve',
			'LINK_COL' => 'id_sh_parent',
			'ITEMS_COL' => 'subOrgList',
			'FEUILLE_COL' => 'employeeList',
			'FEUILLE_COND_METHOD' => '',
			'ALL_ITEMS' => true,
			'EDIT' => false,
			'ICONS' => true,
		...
		'home_latitude' => array(
			...
			'STEP' => 3,
			'TITLE_AFTER' => '(in DEG)',
			'HELP' => "latitude احصل عليه من  <a target='_gps' href='http://www.whatsmygps.com/'>هنا</a> أو من <a target='_gps' href='http://www.coordonnees-gps.fr/'>هنا</a>",
			'SEARCH-BY-ONE' => '',
			'DISPLAY' => true,
			'DISPLAY-UGROUPS' => '',
			'EDIT-UGROUPS' => '',
