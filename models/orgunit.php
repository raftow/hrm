...
class Orgunit extends AFWObject{
	...
	public static $HEAD_COMPANY = 3;
        ...
        protected function getPublicMethods()
        {
            ...
            {
               $arrPublicMethods["xY9cvb"] = array("METHOD"=>"genereSubDepartments", 
            ...
            {
               $arrPublicMethods["xsdf12"] = array("METHOD"=>"loadSubDepartmentsFromApi", 
        ...
        */
        ...
        public function genereSubDepartments($lang="ar", $regen=false)
        {
                ...
                $sub_dep_arr=['IT' => "إدارة الموارد البشرية",
                ...
                {
                        $sdepObj = self::findOrgunit(self::$orgunit_type_department, $this->getId(), $sub_dep_code, $sub_dep, $sub_dep, $this->getVal("id_domain"), 
                                        $create_obj_if_not_found, $update_obj_if_found = false, $hrm_crm="hrm");
        ...
        {
                return (in_array($this->getVal("id_sh_type"),
                                  array(self::$orgunit_type_department,
        ...
        {
            return (in_array($this->getVal("id_sh_type"),
                                  array(self::$orgunit_type_company,
                                        self::$orgunit_type_ministry,
                                        self::$orgunit_type_firm,
        ...
        {
            return (in_array($this->getVal("id_sh_type"),
                                  array(self::$orgunit_type_division,
